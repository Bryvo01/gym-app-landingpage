...
<SectionWrapper id="contact">
  ...
  {#if formSubmitted}
    <div id="success-message" class="flex flex-col items-center justify-center text-center">
  ...
  {:else}
    <form id="contact-form" on:submit|preventDefault={handleSubmit} class="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
